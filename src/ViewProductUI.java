...
public class ViewProductUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewProductUI
     */
    DisplayManager dMgr;
    public ViewProductUI(DisplayManager dMgr) {
        ...
        //populateData(dMgr.mainMgr.searchMgr.ViewProducts());
    ...
    private void RemoveProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveProductActionPerformed
        ...
        else
        {
            ...
            //dMgr.removeProd(prodname, index);
            model.removeRow(i);
           //dMgr.ShopkeeperMain.setVisible(true);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        switch(cat)
        {
            case "Fruit":jComboBox1.setSelectedIndex(0);
            break;
            case "Vegetable":jComboBox1.setSelectedIndex(1);
            break;
            case "Dairy":jComboBox1.setSelectedIndex(2);
            break;
            case "Grocery":jComboBox1.setSelectedIndex(3);
            break;
        }
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        else
        {
            ...
            Catalog p = new Catalog();//mgr.prod1.get(Integer.parseInt(model.getValueAt(i,0).toString())-1);
            ...
            //Product p=mgr.prod1.get(Integer.parseInt(model.getValueAt(i,0).toString())-1); 
            ...
            //dMgr.editProd(Integer.parseInt(model.getValueAt(i,0).toString())-1, p);
    ...
    /*public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new ViewProductUI(new DisplayManager());
            }
        });
